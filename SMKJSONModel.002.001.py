...
def complete_artwork_desc_and_upload(filename, 
    ...
    # Generating Artwork template see: https://commons.wikimedia.org/wiki/Template:Artwork
...
result = empty_from_dict(json_string)
...
for item in result.items:
    if item.has_image: 
        ...
        complete_artwork_desc_and_upload(filename = filename, 
            pagetitle = pagetitle, 
            artist = artist,
            author = author,
            title = title,
            ...
            institution = institution,
            department = department,
            place_of_discovery = place_of_discovery,
